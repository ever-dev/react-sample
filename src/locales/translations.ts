 ...
 */
export const lang: ConvertedToObjectType<TranslationJsonType> = {} as any;
 ...
 */
export const convertLanguageJsonToObject = (json: any, objToConvertTo = lang, current?: string) => {
